...
<button style = "font-size: 16px; border-radius: 24px; border: none; padding: 10px; background: darkblue; color: white" id = 'PressureBtn' onclick="reveal('PressureAbstract', 'PressureBtn')">Show Abstract</button>
<button style = "font-size: 16px; border-radius: 24px; border: none; padding: 10px; background: purple; color: white" id = 'PressureGraphBtn' onclick="reveal('PressureGraph', 'PressureGraphBtn')">Show Graphs</button>


<div id='PressureAbstract' style = "display: none;"><p style="font-size:16px;">
...
<div id='PressureGraph' style = "display: none;">
...
<div id='SteppingStonesGraph' style = "display: block;"><img src="https://ethanholdahl.com/assets/images/SteppingStoneData.png" alt="Stepping Stones Games" style="width:70%;"></div>
...
<a href = "TrustandAI.pdf"><img src="https://ethanholdahl.com/assets/images/TrustAI.png" alt="Screening Graphs" style="width:100%;"></a></div>
