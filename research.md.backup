...
<p style="font-size:24px; margin:0"><strong><a href="https://ethanholdahl.com/files/SelectionPressure.pdf" style="color: darkgreen; text-decoration: none;">Selection Pressure in Strategic Environments</a></strong></p><p style="font-size:16px;">with <a href="https://sites.socsci.uci.edu/~duffy/" style="color: darkgreen; text-decoration: none">John Duffy</a>, <a href="https://sites.google.com/view/stephanjagau" style="color: darkgreen; text-decoration: none">Stephan Jagau</a>, and <a href="https://sites.google.com/uci.edu/franciscoklapp/home" style="color: darkgreen; text-decoration: none">Francisco Klapp</a></p>

<button style = "font-size: 16px; border-radius: 24px; border: none; padding: 10px; background: darkblue; color: white" id = 'PressureBtn' onclick="reveal('PressureAbstract', 'PressureBtn')">Hide Abstract</button>
<button style = "font-size: 16px; border-radius: 24px; border: none; padding: 10px; background: purple; color: white" id = 'PressureGraphBtn' onclick="reveal('PressureGraph', 'PressureGraphBtn')">Hide Graphs</button>


<div id='PressureAbstract' style = "display: block;"><p style="font-size:16px;">
...
<div id='PressureGraph' style = "display: block;">
<img src="https://ethanholdahl.com/assets/images/SelectionPressureTullock.png" alt="Average Bids Per Cycle" style="width:100%;"></a></div>
...
<p style="font-size:24px; margin:0"><strong><a href="https://rdcu.be/daZ4w" style="color: darkgreen; text-decoration: none;">Conflicts, Assortative Matching, and the Evolution of
...
<p style="font-size:16px;">with <a href="https://www.stolaf.edu/profile/binder/" style="color: darkgreen; text-decoration: none">Seth Binder</a>, <span style="color: darkgreen">Ly Trinh</span>, and <span style="color: darkgreen">John H. Smith</span>
</p>
...
<button style = "font-size: 16px; border-radius: 24px; border: none; padding: 10px; background: darkblue; color: white" id = 'SteppingStonesAbstractBtn' onclick="reveal('SteppingStonesAbstract', 'SteppingStonesAbstractBtn')">Show Abstract</button>
<button style = "font-size: 16px; border-radius: 24px; border: none; padding: 10px; background: purple; color: white" id = 'SteppingStonesGraphBtn' onclick="reveal('SteppingStonesGraph', 'SteppingStonesGraphBtn')">Show Graphs</button>

<div id='SteppingStonesAbstract' style = "display: none;">  <p style="font-size:16px;">
...
<div id='ScreeningGraph' style = "display: none;"><img src="https://ethanholdahl.com/assets/images/ScreeningImage.png" alt="Screening Graphs" style="width:100%;"></div>

<p style="font-size:24px; margin:0"><strong><a href="https://ethanholdahl.com/files/TrustandAI.pdf" style="color: darkgreen; text-decoration: none;">The Role of AI in Trust: An Experimental Study</a></strong></p><p style="font-size:16px;">with <a href="https://www.tannerbivins.com" style="color: darkgreen; text-decoration: none">Tanner Bivins</a>, <a href="https://github.com/connortwiegand" style="color: darkgreen; text-decoration: none">Connor Wiegand</a>, and <a href="https://sites.google.com/site/jiabinwuecon" style="color: darkgreen; text-decoration: none">Jiabin Wu</a>
<br><em>Under Review</em></p>

<button style = "font-size: 16px; border-radius: 24px; border: none; padding: 10px; background: darkblue; color: white" id = 'ScreeningBtn' onclick="reveal('TrustAIAbstract', 'TrustAIBtn')">Show Abstract</button>
<button style = "font-size: 16px; border-radius: 24px; border: none; padding: 10px; background: purple; color: white" id = 'TrustAIGraphBtn' onclick="reveal('TrustAIGraph', 'TrustAIGraphBtn')">Show Graphs</button>

<div id='TrustAIAbstract' style = "display: none;"><p style="font-size:16px;">

In this study, we experimentally explore the impact of AI as a supportive tool for players
in a two-player trust game. The game begins with the trustee sending a message to the
trustor. In certain scenarios, the trustee is aided by the large language model (LLM)
ChatGPT in composing this message. In other scenarios, the trustor uses AI to interpret
the message from the trustee, or both players may have access to AI assistance. Our
findings indicate that when the trustee utilizes AI as a helper, it enhances cooperation
with the trustor. Interestingly, this improvement in cooperation is not attributed to AI’s
superior messaging skills. Instead, when the trustee has AI assistance, it may encourage
the trustor to scrutinize the trustee’s message more closely. The detailed scrutiny by
the trustor, and potentially the trustee’s awareness of this scrutiny, aligns the beliefs
of the trustor and the trustee, thereby fostering an environment that encourages the
development of trust.

</p></div>

<div id='TrustAIGraph' style = "display: none;">
<img src="https://ethanholdahl.com/assets/images/TrustAI.png" alt="Screening Graphs" style="width:100%;"></div>

## Works in Progress

<p style="font-size:24px; margin:0"><strong>Graphically Solving for Mixed Nash Equilibria in 2x2 Games</strong></p><p style="font-size:16px;"></p>
